    ...
    <div className="bg-white rounded shadow p-4 max-w-lg">
      ...
      <form className="space-y-4">
        <div>
          ...
          <input type="text" defaultValue="John Doe" className="w-full border p-2 rounded" />
        </div>
        <div>
          <label className="block text-sm">Email</label>
          <input type="email" defaultValue="johndoe@example.com" className="w-full border p-2 rounded" />
        </div>
        <div>
